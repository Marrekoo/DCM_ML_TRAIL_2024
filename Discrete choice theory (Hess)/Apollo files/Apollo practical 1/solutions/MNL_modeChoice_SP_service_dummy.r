...
### Set core controls
apollo_control = list(
  modelName       = "MNL_modeChoice_SP_service_dummy",
  modelDescr      = "MNL model on mode choice SP data with categorical service quality variable",
  indivID         = "ID", 
