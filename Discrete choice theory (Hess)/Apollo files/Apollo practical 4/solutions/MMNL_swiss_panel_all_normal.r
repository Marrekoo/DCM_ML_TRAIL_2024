...
### Set core controls
apollo_control = list(
  modelName       = "MMNL_swiss_panel_all_normal",
  modelDescr      = "MMNL model with Normal distributions for all four coefficients on Swiss route choice data",
  indivID         = "ID",
  nCores          = 3, 
...
apollo_randCoeff = function(apollo_beta, apollo_inputs){
  ...
  randcoeff[["b_hw"]] = b_hw_mu + b_hw_sig * draws_hw 
  randcoeff[["b_ch"]] = b_ch_mu + b_ch_sig * draws_ch 
...
# ----------------------------------------------------------------- #
#---- LR TEST AGAINST MMNL MODEL WITH TWO NORMALS                ----
# ----------------------------------------------------------------- #
