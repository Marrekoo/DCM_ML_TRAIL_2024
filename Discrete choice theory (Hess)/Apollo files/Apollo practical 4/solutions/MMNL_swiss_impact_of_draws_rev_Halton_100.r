...
### Set core controls
apollo_control = list(
  modelName       = "MMNL_swiss_impact_of_draws_rev_Halton_100",
  modelDescr      = "MMNL, four neg Lognormals, 100 Haltons, reversed order of primes",
  indivID         = "ID",
  nCores          = 3,
...
apollo_draws = list(
  ...
  interNDraws    = 100,
  interNormDraws = c("draws_ch","draws_hw","draws_tc","draws_tt")
)
