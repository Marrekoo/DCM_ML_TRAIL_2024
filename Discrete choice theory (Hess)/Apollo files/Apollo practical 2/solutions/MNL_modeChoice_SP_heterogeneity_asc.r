...
### Set core controls
apollo_control = list(
  modelName       = "MNL_modeChoice_SP_heterogeneity_asc",
  modelDescr      = "MNL model on mode choice SP data with heterogeneity in ASC",
  indivID         = "ID",
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ### Create alternative specific constants with interactions with socio-demographics
...
apollo_lrTest("MNL_modeChoice_SP_mode_specific_time",model)
